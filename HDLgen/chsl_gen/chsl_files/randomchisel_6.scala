...
class randomchisel extends Module {
	...
	when(~(~(((!io.a0(1,0))).asUInt) ^ (~(io.a1(3)<io.a1(0))).asUInt).asBool) {
		y0 := ((io.a4) - (~io.a0))} .otherwise {
		y0 := (io.a0)}
	y1 := ((~io.a2(3,0)) + (~io.a2(3,0)))
	y2 := Mux((io.a1(0)).asUInt.asBool,((io.a2) + (io.a2)),~((~io.a2) | ~((~io.a2))))
	y3 := Mux(((!io.a0(1,0))).asUInt.asBool,(io.a3(5,0)),(io.a3(5,0)))
	when(((~(!io.a0(2,1))).asUInt - ((io.a0(2)=/=io.a4(1))).asUInt).asBool) {
		y4 := (io.a4)} .otherwise {
		y4 := (io.a0)}
