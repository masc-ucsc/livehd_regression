...
class randomchisel extends Module {
	...
	y0 := Mux(((~(!io.a1(3,1))).asUInt - ((!io.a1(3,2))).asUInt).asBool,~(((~io.a0)) & (~io.a0)),(~io.a4))
	when(~((((!io.a1(3,1))).asUInt) ^ (y0(0)).asUInt).asBool) {
		y1 := (~io.a2(3,0))} .otherwise {
		y1 := (~io.a1(3,0))}
	when(~(((!io.a2(2,1))).asUInt + (~(io.a1(3)&&io.a1(2))).asUInt).asBool) {
		y2 := (io.a2)} .otherwise {
		y2 := (~io.a2)}
	y3 := Mux((~(io.a1(3)<io.a1(2))).asUInt.asBool,(io.a3(5,0)),(~io.a3(5,0)))
	y4 := ~((y0) + (~io.a4))
