...
class randomchisel extends Module {
	...
	when(~((~io.a2(0)).asUInt + (io.a0(0)).asUInt).asBool) {
		y0 := ~((io.a0) | ~((~io.a4)))} .otherwise {
		y0 := ((io.a4) + (~io.a0))}
	y1 := Mux(~(((!io.a1(3,1))).asUInt - (~(!io.a2(2,1))).asUInt).asBool,(~io.a1(3,0)),(~io.a1(3,0)))
	y2 := ((~io.a2) & (io.a2))
	y3 := Mux((io.a4(0)).asUInt.asBool,(~io.a3(5,0)),(~io.a3(5,0)))
	y4 := ((io.a0) | (io.a4))
