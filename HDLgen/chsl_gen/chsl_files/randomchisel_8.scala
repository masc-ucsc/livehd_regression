...
class randomchisel extends Module {
	...
	when(((io.a1(3)>io.a1(2))).asUInt.asBool) {
		y0 := (io.a4)} .otherwise {
		y0 := ~((io.a4) - (io.a0))}
	when(~(~((~(io.a2(4)>io.a2(2))).asUInt) & (~io.a1(2)).asUInt).asBool) {
		y1 := ~((io.a3(3,0)) - (io.a2(3,0)))} .otherwise {
		y1 := (((~io.a2(3,0))) | (io.a2(3,0)))}
	y2 := ~(((io.a2) & (~io.a2)) & ~((~io.a2) - (io.a2)))
	y3 := (((~io.a3(5,0)) ^ ~((io.a3(5,0)))) & (((io.a3(5,0))) | ~((~io.a3(5,0)))))
	when(~((io.a4(0)).asUInt - (~(!y0(2,0))).asUInt).asBool) {
		y4 := (io.a4)} .otherwise {
		y4 := (io.a4)}
